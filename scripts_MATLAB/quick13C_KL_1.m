function [newformulas, totC13pairs, c13pairs] = quick13C_KL_1(formulas,NeutralMass,showProgress)  
%function [newformulas, totC13pairs, c13pairs] = quick13C_KL_1(formulas,NeutralMass,showProgress)  
...
% MB changed output to include variable totC13 pairs and c13pairs (idx
% values of c13 peaks, parent and daughter)
% KL 9/1/2011 - changed the error calculation to spit out the absolute
